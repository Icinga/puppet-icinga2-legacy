...
#
class icinga2::pki::puppet(
  $ca_path     = "${::icinga2::params::i2dirprefix}/etc/icinga2/pki/ca.crt",
  $ca_source   = "${::settings::ssldir}/certs/ca.pem",
  $cert_path   = "${::icinga2::params::i2dirprefix}/etc/icinga2/pki/${::fqdn}.crt",
  $cert_source = "${::settings::ssldir}/certs/${::fqdn}.pem",
  $key_path    = "${::icinga2::params::i2dirprefix}/etc/icinga2/pki/${::fqdn}.key",
  $key_source  = "${::settings::ssldir}/private_keys/${::fqdn}.pem",
  $crl_path    = "${::icinga2::params::i2dirprefix}/etc/icinga2/pki/crl.pem",
